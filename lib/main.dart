...
import 'package:quizzler/quick_brain.dart';
    ...
    setState(() {
      ...
      if (quizBrain.isFinished()) {
        ...
        Alert(
          ...
          content: Column(
            children: <Widget>[
              Text("You've reached the end quiz!"),
              SizedBox(
                height: 10.0,
              ),
              Row(
            ...
            child: Center(
              child: CircularPercentIndicator(
                ...
                percent: quizBrain.isFinished()
                    ? 1.0
                    : (quizBrain.questionNumber + 1) / quizBrain.totalQuestion,
                backgroundColor: Colors.purple,
                progressColor: Colors.yellow,
                center: Text(
                  quizBrain.isFinished()
                      ? quizBrain.totalQuestion.toString() +
                          '/' +
                          quizBrain.totalQuestion.toString()
